...
export const SLASH_COMMANDS = [
  ...
  { cmd: '/chats',                        desc: 'list and load a previously saved chat',                                              args: '[name]'  },
  { cmd: '/chat-new',                     desc: 'start a new chat (resets all settings)',                                              args: ''  },
  { cmd: '/chat-rename',                  desc: 'rename the current chat',                                                             args: ' ' },
