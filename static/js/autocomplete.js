...
export const SLASH_COMMANDS = [
  ...
  { cmd: '/generation-steps',             desc: 'override steps for image generation workflows (e.g. 20)',                            args: ' ' },
  ...
  { cmd: '/resolution',                   desc: 'set image output resolution (e.g. 640x480 or phone)',                                args: ' ' },
  ...
  { cmd: '/workflow',                     desc: 'choose an image generation workflow template',                                       args: ''  },
